<div class="row">
    <!--J站顧客人數高斯圖BEGIN-->
    <div class="card m-3 p-3 shadow round-3"
        style="width: 24rem; background-image: linear-gradient(#ffffff, #ffffff, #88ffff)">
        <div class="card-body">
            <h5 class="card-title"><i class="fs-2 bi-people px-3 text-info"></i>顧客2222</h5>
            <?php
    ...
    <!--分公司內員工長條圖BEGIN-->
    <div class="card m-3 p-3 shadow round-3"
        style="width: 36rem; background-image: linear-gradient(#ffffff, #ffffff, #ffff00)">
        <div class="card-body">
    ...
    <div class="card m-3 p-3 shadow round-3"
        ...
        <div class="card-body">
            ...
            ?>
            <div id="polarbarOfficeEmployees" style="height: 18rem; width: 100%"></div>
            <a href="ordersAll.php" class="btn btn-primary">更多...</a>
            <script type="text/javascript">
                var dom = document.getElementById('polarbarOfficeEmployees');
                ...
                option = {
                    title: [{ text: '分公司員工人數' }],
                    polar: { radius: [30, '100%'] },
                    angleAxis: { max: 7, startAngle: 45 },  /* 這個MAX7，要再寫一個VIEW來產生 */
                    radiusAxis: { type: 'category', data: <?php echo json_encode($office, JSON_NUMERIC_CHECK) ?> },
                    tooltip: {},
                    series: {
                        type: 'bar',
                        data: <?php echo json_encode($countEmployees, JSON_NUMERIC_CHECK) ?>,
                        coordinateSystem: 'polar',
                        label: { show: true, position: 'middle', formatter: '{b}{c}人' }
                    }
                };
                if (option && typeof option === 'object') { myChart.setOption(option); }
                window.addEventListener('resize', myChart.resize);
    ...
    <div class="card m-3 p-3 shadow round-3"
        style="width: 24rem; background-image: linear-gradient(#ffffff, #ffffff, #996515)">
        <div class="card-body">
    ...
    <div class="card m-3 p-3 shadow round-3"
        style="width: 36rem; background-image: linear-gradient(#ffffff, #ffffff, #996515)">
        <div class="card-body">
