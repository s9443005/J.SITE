        ...
        <div class="row flex-nowrap">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>";
                    echo "<th class='bg-primary text-white' width=80>產品線</th>";
                    echo "<th class='bg-primary text-white' width=520>文字描述</th>";
                    echo "<th class='bg-primary text-white' width=100>HTML描述</th>";
                    echo "<th class='bg-primary text-white' width=100>圖片</th>";
                    echo "</tr>";
                    echo "<tr>";
                    echo "<td>" . $row['productLine'] . "</td>";
                    echo "<td>" . $row['textDescription'] . "</td>";
                    echo "<td>" . "NULL" . "</td>";
                    echo "<td>" . "<img src='img/lines/" . $row['image']. "' class='img-fluid img-thumbnail' alt='...' ></td>";
                    echo "</tr>";
                    echo "</table>";
                    echo "</div>";
                    echo "</div>";
